  ...
  <div class="row myCenter">
   ...
   <div class="panel-body">
      <form class="form-signin">
        ...
        <img src="<?php echo base_url('/static/img/logo.png')?>" class="img-rounded" alt="Ralyblog v1.0" width="200" height="130"> 
        </div>
        <div>
        ...
        <label for="inputPPassword" class="sr-only">确认密码</label>
        <input type="password" id="inputPPassword" class="form-control" name="acpassword" value="<?php echo set_value('acpassword'); ?>" placeholder="确认密码">
        <p class="text-danger"><?php echo form_error('acpassword'); ?></p>
